...
# Configs
PRODUCT_COPY_FILES += \
    device/htc/inc/media_codecs.xml:system/etc/media_codecs.xml \
    device/htc/inc/audio_policy.conf:system/etc/audio_policy.conf

# Misc
PRODUCT_COPY_FILES += \
    device/htc/inc/init.power.rc:root/init.power.rc
